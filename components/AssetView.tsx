  ...
  return (
    <div className="animate-in fade-in slide-in-from-right-8 duration-500 h-full flex flex-col">
      ...
      <div className="mb-8">
        ...
        <p className="text-gray-500 text-sm font-medium">Configure global standards for game titles and visual themes.</p>
      </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {filteredAssets.length > 0 ? (
            ...
            <div className="col-span-full py-20 text-center border border-dashed border-white/10 rounded-2xl">
                <p className="text-gray-500 text-xs font-bold uppercase tracking-widest">NO ASSETS CONFIGURED FOR THIS THEME</p>
            </div>
        )}
      </div>
    </div>
