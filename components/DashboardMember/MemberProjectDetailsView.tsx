...
const MemberProjectDetailsView: React.FC<MemberProjectDetailsViewProps> = ({ 
  ...
  const handleUpdatePlayers = (updatedPlayers: PlayerData[]) => {
    onUpdateProject({ ...project, players: updatedPlayers });
  };
  ...
  const handleRestoreTeam = (team: ArchivedTeam) => {
      ...
      if (exists) {
          alert(`Team "${team.name}" already exists in active roster. Please rename one of them first.`);
          return;
      }
  ...
  const handleStartSync = () => {
    if (!sheetId || !sheetKey) {
        alert("PLEASE ENTER SPREADSHEET URL AND API KEY.");
        return;
    }
    setIsSyncing(true);
              ...
              <div className="flex items-center gap-4">
                ...
                <div>
                    <h1 className="text-3xl font-[1000] italic text-white uppercase tracking-tighter leading-none mb-2">
                        MANUAL <span className="text-[#ccff00]">ENTRY</span>
                    </h1>
                    <p className="text-[10px] font-black text-zinc-600 uppercase tracking-[0.4em]">DATABASE ROSTER PEMAIN</p>
                </div>
              </div>
              ...
              <div className="flex items-center gap-3">
                  ...
                  >
                    ...
                    <div className="text-left">
                      <p className="text-[10px] font-[1000] uppercase tracking-widest leading-none mb-1">ADD NEW TEAM</p>
                      <p className="text-[6px] font-black opacity-60 uppercase tracking-widest">INPUT MANUAL ROSTER</p>
                    </div>
                  </button>
              </div>
            </div>
        ...
        <div className="flex flex-col gap-4 pb-20 px-2 sm:px-0">
            {teamListManagementData.length > 0 && (
                <div className="hidden md:grid grid-cols-12 px-6 py-2 text-[8px] font-black text-zinc-600 uppercase tracking-[0.2em] border-b border-white/5 mb-2">
                    ...
                    <div className="col-span-4">TEAM IDENTITY</div>
                    <div className="col-span-3">ROSTER COUNT</div>
                    <div className="col-span-4 text-right">CONTROLS</div>
                </div>
            )}
                ...
                <div key={idx} className="flex flex-col md:grid md:grid-cols-12 items-start md:items-center bg-zinc-900/30 border border-white/5 p-4 md:p-3 rounded-2xl md:rounded-2xl hover:border-white/20 transition-all group overflow-hidden relative gap-4 md:gap-0">
                    ...
                    <div className="flex md:col-span-1 items-center gap-4 md:gap-0 md:justify-center w-full md:w-auto">
                        ...
                        <div className="md:hidden">
                            ...
                            <p className="text-[8px] font-bold text-zinc-600 uppercase tracking-widest mt-1.5">VERIFIED NODE</p>
                        </div>
                    </div>
                    ...
                    <div className="hidden md:block md:col-span-4">
                        ...
                        <p className="text-[7px] font-bold text-zinc-600 uppercase tracking-widest mt-1">VERIFIED NODE</p>
                    </div>
                    ...
                    <div className="md:col-span-4 flex items-center justify-between md:justify-end gap-3 w-full md:w-auto">
                        ...
                        >
                            ...
                            EDIT <span className="md:hidden">TEAM</span>
                        </button>
                        <button 
                            ...
                            title="Archive Team (Move to History)"
                        >
            ...
            {teamListManagementData.length === 0 && (
                <div className="py-32 flex flex-col items-center justify-center opacity-30 border-2 border-dashed border-white/5 rounded-[40px] bg-zinc-900/10">
                    ...
                    <p className="text-xs font-black uppercase tracking-[0.4em] text-zinc-500">NO TEAM DATA LOADED</p>
                </div>
            )}
        </div>
                ...
                <div className="relative w-full max-w-2xl bg-[#0a0a0a] border border-white/10 rounded-[32px] overflow-hidden flex flex-col max-h-[80vh] animate-in zoom-in-95 shadow-2xl">
                    <div className="p-8 border-b border-white/5 flex justify-between items-center bg-zinc-950/50">
                        <div className="flex items-center gap-4">
                            ...
                            <div>
                                <h3 className="text-xl font-black italic text-white uppercase tracking-tighter">ARCHIVED TEAMS</h3>
                                <p className="text-[9px] font-black text-zinc-600 uppercase tracking-widest">RECYCLE BIN</p>
                            </div>
                        </div>
                    ...
                    <div className="flex-1 overflow-y-auto p-6 space-y-3 custom-scrollbar">
                        {deletedTeams.length === 0 ? (
                            <div className="py-12 text-center opacity-30">
                                ...
                                <p className="text-[10px] font-black uppercase tracking-widest">BIN IS EMPTY</p>
                            </div>
                        ) : (
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 mt-1">
                                                <span className="text-[8px] font-bold text-zinc-500 uppercase tracking-widest">{team.players.length} PLAYERS</span>
                                                <span className="text-[8px] font-bold text-zinc-700 uppercase tracking-widest">&bull;</span>
                                                <span className="text-[8px] font-bold text-zinc-600 uppercase tracking-widest">DEL: {team.deletedAt}</span>
                                            </div>
                                        </div>
                                    </div>
            ...
            <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
                ...
                <div className="relative w-full max-w-md bg-[#050505] border border-red-500/20 rounded-[40px] p-10 animate-in zoom-in-95 duration-300 shadow-[0_0_80px_rgba(239,68,68,0.1)] flex flex-col items-center text-center">
                    ...
                    <p className="text-[10px] font-black text-zinc-600 tracking-[0.2em] uppercase mb-8 leading-relaxed max-w-[280px]">
                        Are you sure you want to remove team <span className="text-white">"{teamToArchive}"</span>? Data will be moved to history.
                    </p>
    ...
    <div className="animate-in fade-in slide-in-from-right-8 duration-500 h-full flex flex-col font-inter">
      ...
      <div className="relative w-full h-[320px] rounded-[40px] overflow-hidden group shadow-2xl mb-12 border border-white/5 bg-[#0a0a0a]">
        ...
        <div className="absolute inset-0 flex flex-col items-center justify-center text-center z-10 px-6">
           ...
           <p className="text-zinc-400 text-[9px] md:text-[10px] font-black uppercase tracking-[0.4em] opacity-80 max-w-lg mb-4 md:mb-0">
             {project.description || "OPERATIONAL BROADCAST NODE READY FOR DEPLOYMENT."}
           </p>
        </div>
        ...
        <div className="absolute bottom-8 right-8 z-20 flex flex-col items-end gap-3">
          ...
          <div className="px-3 py-1 rounded bg-black/40 backdrop-blur-sm border border-white/5">
             <p className="text-[8px] font-black text-zinc-600 uppercase tracking-widest">REC: 1920X1080 (HD)</p>
          </div>
        </div>
      </div>
      ...
      <div className="flex items-center gap-4 mb-8 px-4 overflow-x-auto no-scrollbar pb-2">
          ...
          >
            ...
            <div className="text-left min-w-[120px]">
              <p className="text-[10px] font-black text-white uppercase tracking-widest leading-none mb-1">DATA PEMAIN</p>
              <p className="text-[8px] font-bold text-zinc-600 uppercase tracking-widest">HALAMAN INPUT DATA</p>
            </div>
          ...
          >
            ...
            <div className="text-left min-w-[120px]">
              <p className="text-[10px] font-black text-white uppercase tracking-widest leading-none mb-1">IP CONNECT</p>
              <p className="text-[8px] font-bold text-zinc-600 uppercase tracking-widest">GAME DEVELOPER LINK</p>
            </div>
          ...
          >
            ...
            <div className="text-left min-w-[120px]">
              <p className="text-[10px] font-black text-white uppercase tracking-widest leading-none mb-1">GOOGLE SHEETS</p>
              <p className="text-[8px] font-bold text-zinc-600 uppercase tracking-widest">SYNC EXTERNAL DATA</p>
            </div>
          ...
          >
            ...
            <div className="text-left min-w-[100px]">
              <p className={`text-[10px] font-black uppercase tracking-widest leading-none mb-1 ${teamCount > 0 ? 'text-white' : 'text-zinc-600'}`}>DATA TEAM</p>
              <p className={`text-[8px] font-bold uppercase tracking-widest ${teamCount > 0 ? 'text-blue-500' : 'text-zinc-800'}`}>
                {teamCount > 0 ? `${teamCount} TEAMS SAVED` : 'NO DATA'}
              </p>
            </div>
      ...
      <section className="px-4 flex-1">
        <div className="flex items-center justify-between mb-10 border-b border-white/5 pb-4">
          <div className="flex items-center gap-3">
            <h2 className="text-[12px] font-black text-zinc-500 tracking-[0.5em] uppercase">DEPLOYED NODE FILES</h2>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-8 pb-32">
          ...
          >
             ...
             <span className="text-[10px] font-black text-zinc-800 tracking-[0.2em] uppercase group-hover:text-zinc-500 transition-colors">DEPLOY NEW NODE</span>
          </button>
        </div>
      </section>
      ...
      {isIpModalOpen && (
        <div className="fixed inset-0 z-[200] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-[#0a0a0a] border border-purple-500/30 rounded-[48px] p-10 shadow-2xl animate-in zoom-in-95">
            ...
            <div className="mb-8">
                <div className="flex items-center gap-2 mb-2"><Wifi size={14} className="text-purple-500 animate-pulse"/><span className="text-[10px] font-black text-zinc-500 tracking-[0.4em] uppercase">DEV_LINK</span></div>
                <h2 className="text-2xl font-black text-white italic uppercase tracking-tighter">IP <span className="text-purple-500">CONNECT</span></h2>
            </div>
            <div className="space-y-4">
                <div className="space-y-2">
                    <label className="text-[9px] font-black text-zinc-600 tracking-widest uppercase ml-4">SERVER IP ADDRESS</label>
                ...
                <div className="space-y-2">
                    <label className="text-[9px] font-black text-zinc-600 tracking-widest uppercase ml-4">ACCESS TOKEN</label>
                ...
                <button className="w-full bg-purple-600 text-white py-5 rounded-[24px] font-black text-xs tracking-[0.2em] uppercase hover:bg-purple-500 transition-all shadow-[0_0_30px_rgba(168,85,247,0.3)] mt-4">ESTABLISH HANDSHAKE</button>
            </div>
          </div>
        </div>
      )}
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 h-full overflow-hidden">
                ...
                <div className="p-10 border-r border-white/5 flex flex-col h-full overflow-hidden">
                    <div className="mb-6 shrink-0">
                        <div className="flex items-center gap-2 mb-2">
                            ...
                            <span className="text-[10px] font-black text-zinc-500 tracking-[0.4em] uppercase">SYNC_CORE</span>
                        </div>
                        <h2 className="text-3xl font-[1000] text-white italic uppercase tracking-tighter leading-none mb-1">GOOGLE <span className="text-green-500">SHEETS</span></h2>
                        <p className="text-[9px] font-bold text-zinc-600 uppercase tracking-widest leading-relaxed">SINKRONISASI DATA PLAYER & TEAM SECARA REAL-TIME.</p>
                    </div>

                    <div className="space-y-4 shrink-0">
                        <div className="space-y-2">
                            <label className="text-[9px] font-black text-zinc-600 tracking-widest uppercase ml-4 flex items-center gap-2">
                                <Key size={10} className="text-green-500" /> GOOGLE API KEY
                            </label>
                            <input 
                                type="password" 
                                value={sheetKey}
                        ...
                        <div className="space-y-2 relative">
                            <label className="text-[9px] font-black text-zinc-600 tracking-widest uppercase ml-4 flex items-center gap-2">
                                <Link size={10} className="text-green-500" /> SPREADSHEET URL / ID
                            </label>
                            <input 
                                type="text" 
                                value={sheetId}
                    ...
                    <div className="mt-6 flex-1 flex flex-col bg-black/40 border border-white/5 rounded-[32px] p-6 overflow-hidden min-h-[200px]">
                        <div className="flex items-center justify-between mb-4 shrink-0">
                            <div className="flex items-center gap-2">
                                ...
                                <span className="text-[9px] font-black text-zinc-500 tracking-widest uppercase">REALTIME FEED</span>
                            </div>
                            {hasSynced && (
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 space-y-2">
                            {isSyncing ? (
                                <div className="h-full flex flex-col items-center justify-center space-y-4 opacity-50">
                                    ...
                                    <p className="text-[9px] font-black text-zinc-500 uppercase tracking-widest">POLLING DATA STREAM...</p>
                                </div>
                            ) : hasSynced ? (
                                <>
                                    {[
                                ...
                                <div className="h-full flex flex-col items-center justify-center opacity-30 text-center px-6">
                                    ...
                                    <p className="text-[8px] font-bold text-zinc-500 uppercase tracking-widest">AWAITING HANDSHAKE INITIALIZATION TO BEGIN STREAMING INFORMATION.</p>
                                </div>
                            )}
                        </div>
                    </div>
                    ...
                    <div className="pt-6 shrink-0">
                        ...
                        >
                            ...
                            ) : hasSynced ? 'RE-INITIALIZE UPLINK' : 'INITIALIZE HANDSHAKE'}
                        </button>
                    </div>
                </div>
                ...
                <div className="bg-zinc-900/50 p-10 flex flex-col h-full overflow-y-auto custom-scrollbar">
                    <div className="flex items-center gap-3 mb-10 shrink-0">
                        ...
                        <div>
                            <h3 className="text-md font-black text-white uppercase tracking-widest leading-none mb-1">USER GUIDE</h3>
                            <p className="text-[9px] font-bold text-zinc-500 uppercase tracking-widest">HOW TO SYNC DATA</p>
                        </div>
                    </div>
                    ...
                    <div className="space-y-8 flex-1">
                        <div className="space-y-4">
                            <div className="flex gap-5">
                                ...
                                <div className="space-y-2">
                                    <h4 className="text-[11px] font-black text-white uppercase tracking-widest">DOWNLOAD CSV TEMPLATE</h4>
                                    <p className="text-[9px] text-zinc-500 leading-relaxed uppercase font-medium">Klik tombol di bawah untuk mendapatkan struktur file CSV yang sudah dikonfigurasi untuk BROHUBS.</p>
                                    <button 
                            ...
                            <div className="flex gap-5">
                                ...
                                <div className="space-y-2">
                                    <h4 className="text-[11px] font-black text-white uppercase tracking-widest">IMPORT KE GOOGLE SHEETS</h4>
                                    <p className="text-[9px] text-zinc-500 leading-relaxed uppercase font-medium">Buka Google Sheets, lalu pilih <span className="text-white">File &gt; Import &gt; Upload</span> dan pilih file CSV yang baru di-download.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5">
                                ...
                                <div className="space-y-2">
                                    <h4 className="text-[11px] font-black text-white uppercase tracking-widest">AKTIFKAN AKSES PUBLIK</h4>
                                    <p className="text-[9px] text-zinc-500 leading-relaxed uppercase font-medium">Klik tombol <span className="text-white">Share</span> di pojok kanan atas, lalu ubah akses menjadi <span className="text-white">"Anyone with the link can view"</span>.</p>
                                </div>
                            </div>
                            ...
                            <div className="flex gap-5">
                                ...
                                <div className="space-y-2">
                                    <h4 className="text-[11px] font-black text-white uppercase tracking-widest">MASUKKAN API KEY & URL</h4>
                                    <p className="text-[9px] text-zinc-500 leading-relaxed uppercase font-medium">Salin URL spreadsheet dan tempel di input <span className="text-white">SYNC_CORE</span> bersama dengan API Key Anda.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="p-6 bg-green-500/5 border border-green-500/10 rounded-[32px] flex items-start gap-4">
                            ...
                            <div className="space-y-1">
                                <p className="text-[10px] font-black text-green-500 uppercase tracking-widest">PRO TIP</p>
                                <p className="text-[9px] font-medium text-green-500/70 uppercase tracking-widest leading-relaxed">System akan secara otomatis memperbarui data setiap 5 detik setelah handshake berhasil dilakukan.</p>
                            </div>
                        </div>
                    </div>
                </div>
