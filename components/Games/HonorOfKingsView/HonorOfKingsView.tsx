...
interface HonorOfKingsViewProps {
  onBack: () => void;
  themes: Theme[];
...
const HOK_ASSETS: Asset[] = [
    { id: 'hok-a1', name: 'DRAGON TIMER', type: 'OBJECTIVE HUD', gameId: 'HOK', description: 'Objective respawn tracking.', active: true, locked: false, category: 'INGAME', nodeStatus: 'LOCAL NODE' },
];

const HonorOfKingsView: React.FC<HonorOfKingsViewProps> = ({
  onBack,
  themes,
  setThemes,
  onSelectTheme,
    ...
    <div className="animate-in fade-in slide-in-from-bottom-8 duration-700 min-h-full flex flex-col">
      <div className="relative w-full h-80 rounded-[40px] overflow-hidden mb-8 group shrink-0">
        <div className="absolute inset-0">
            <img 
                src="https://images.unsplash.com/photo-1560253023-3ec5d502959f?q=80&w=2070&auto=format&fit=crop" 
        ...
        <div className="absolute bottom-8 left-8 z-20">
            <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter text-white uppercase leading-none mb-4">
                HONOR OF <span className="text-[#ccff00]">KINGS</span>
            </h1>
            <p className="text-gray-400 text-sm font-medium max-w-lg leading-relaxed">
                High-fidelity MOBA broadcast assets for Honor of Kings. Gold gap visualizations, objective timers, and team fight analysis HUDs.
            </p>
        </div>
      </div>
...
export default HonorOfKingsView;
