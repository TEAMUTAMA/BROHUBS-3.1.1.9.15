...
import { ArrowLeft, Trophy, Globe, Search, Filter, Layout, Plus } from 'lucide-react';
...
const MLBB_ASSETS: Asset[] = [
    { id: 'mlbb-a1', name: 'DRAFT PICK', type: 'BAN/PICK UI', gameId: 'MLBB', description: 'Tournament standard ban & pick phase overlay.', active: true, locked: false, category: 'INGAME', nodeStatus: 'GLOBAL NODE' },
    { id: 'mlbb-a2', name: 'GOLD GRAPH', type: 'DATA WIDGET', gameId: 'MLBB', description: 'Real-time gold difference visualizer.', active: true, locked: false, category: 'INGAME', nodeStatus: 'LOCAL NODE' },
    { id: 'mlbb-a3', name: 'POST MATCH', type: 'SUMMARY CARD', gameId: 'MLBB', description: 'End game scoreboard and MVP highlight.', active: true, locked: false, category: 'ENDGAME', nodeStatus: 'GLOBAL NODE' },
];
      ...
      <div className="relative w-full h-80 rounded-[40px] overflow-hidden mb-8 group shrink-0">
        ...
        <div className="absolute bottom-8 left-8 z-20">
            <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter text-white uppercase leading-none mb-4">
                MOBILE <span className="text-[#ccff00]">LEGENDS</span>
            </h1>
            <p className="text-gray-400 text-sm font-medium max-w-lg leading-relaxed">
                Premium production suite for Mobile Legends: Bang Bang. Featuring hero selection overlays, gold gap trackers, and real-time turret status.
            </p>
        </div>
      </div>
