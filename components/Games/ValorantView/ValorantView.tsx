...
import { ArrowLeft, Trophy, Globe, Layout, Plus } from 'lucide-react';
...
const VALORANT_ASSETS: Asset[] = [
    { id: 'val-a1', name: 'AGENT SELECT', type: 'PRE-GAME UI', gameId: 'VAL', description: 'Tactical agent selection screen.', active: true, locked: false, category: 'INGAME', nodeStatus: 'GLOBAL NODE' },
    { id: 'val-a2', name: 'SPIKE TIMER', type: 'HUD WIDGET', gameId: 'VAL', description: 'Precise countdown synchronized with game API.', active: true, locked: false, category: 'INGAME', nodeStatus: 'LOCAL NODE' },
];
      ...
      <div className="relative w-full h-80 rounded-[40px] overflow-hidden mb-8 group shrink-0">
        ...
        <div className="absolute bottom-8 left-8 z-20">
            <h1 className="text-5xl md:text-7xl font-black italic tracking-tighter text-white uppercase leading-none mb-4">
                VALORANT <span className="text-[#ccff00]">HUB</span>
            </h1>
            <p className="text-gray-400 text-sm font-medium max-w-lg leading-relaxed">
                Sleek tactical broadcast components for Valorant. Agent ability trackers, spike timers, and automated round recap graphics.
            </p>
        </div>
      </div>
