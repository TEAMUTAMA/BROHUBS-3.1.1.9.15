  ...
  return (
    <div className="animate-in fade-in slide-in-from-bottom-4 duration-500 w-full">
      <div className="flex flex-col md:flex-row justify-between items-center mb-10 gap-4">
        <h1 className="text-4xl font-black tracking-tight text-white shrink-0">Member Management</h1>
                ...
                <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-6">
                    ...
                    <div className="flex items-center gap-2 w-full md:w-auto">
                        ...
                        <button 
                            ...
                            title={`Filter: ${requestFilterType}`}
                        >
                            <Filter size={16} />
                        </button>
                ...
                <div className="flex-1 overflow-y-auto space-y-4 custom-scrollbar pr-2">
                    {!hasFilteredResults && totalRequests > 0 ? (
                        <div className="flex flex-col items-center justify-center py-10 text-center opacity-50">
                            ...
                            <p className="text-[10px] text-gray-500 uppercase tracking-widest">NO MATCHING REQUESTS</p>
                        </div>
                    ) : totalRequests === 0 ? (
                        <div className="flex flex-col items-center justify-center py-20 text-center opacity-50">
                            ...
                            <h3 className="text-white font-bold uppercase tracking-widest mb-1">ALL CAUGHT UP</h3>
                            <p className="text-[10px] text-gray-500 uppercase tracking-widest">NO PENDING REQUESTS FOUND</p>
                        </div>
                    ) : (
                        <>
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            <div className="flex items-center gap-2 mb-1">
                                                ...
                                                <span className="text-[8px] font-black bg-red-500 text-white px-2 py-0.5 rounded tracking-widest">CRITICAL</span>
                                            </div>
                                            <p className="text-[10px] font-bold text-red-400/60 uppercase tracking-wider">REQUESTED PASSWORD RESET</p>
                                        </div>
                                    </div>
                                    <button 
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <div className="flex items-center gap-2 text-[10px] font-bold text-amber-500/80 uppercase tracking-wider">
                                                <span>REQ: {member.requestedPackage || 'RENEWAL'}</span>
                                                <span className="text-zinc-700">&bull;</span>
                                                <span>CUR: {member.package}</span>
                                            </div>
                                        </div>
                                    </div>
                                    <button 
      ...
      <div className="bg-black border border-white/5 rounded-[32px] overflow-hidden shadow-2xl">
        ...
        <div className="hidden md:grid grid-cols-12 gap-4 px-8 py-6 border-b border-white/5">
          <div className="col-span-4 text-[10px] font-black text-zinc-500 tracking-[0.2em] uppercase">USER DETAILS</div>
          <div className="col-span-2 text-[10px] font-black text-zinc-500 tracking-[0.2em] uppercase text-center">STATUS</div>
          <div className="col-span-2 text-[10px] font-black text-zinc-500 tracking-[0.2em] uppercase text-center">PACKAGE</div>
          <div className="col-span-2 text-[10px] font-black text-zinc-500 tracking-[0.2em] uppercase">SUBSCRIPTION</div>
          <div className="col-span-2 text-[10px] font-black text-zinc-500 tracking-[0.2em] uppercase text-right">CONTROLS</div>
        </div>
          ...
          {filteredMembers.length > 0 ? (
            filteredMembers.map((member, idx) => {
                ...
                >
                    ...
                    <div className="flex md:hidden items-center justify-between w-full py-2 border-y border-white/5 my-2">
                        <div className="flex flex-col gap-1">
                          <span className="text-[8px] font-black text-zinc-600 tracking-[0.2em] uppercase">PACKAGE</span>
                          <button 
                            onClick={(e) => {
                              e.stopPropagation();
                        ...
                        <div className="flex flex-col gap-1 items-end">
                            <span className="text-[8px] font-black text-zinc-600 tracking-[0.2em] uppercase">EXPIRY</span>
                    ...
                    <div className="md:col-span-2 flex items-center justify-end relative w-full md:w-auto">
                        ...
                        {needsExtension ? (
                            ...
                            <div className="flex items-center justify-between md:justify-end w-full md:w-auto gap-2">
                                ...
                                {copyFeedback === member.email ? 'COPIED' : 'COPY'}
                                </button>
                            </div>
                        )}
                    </div>
             ...
             <div className="p-12 text-center text-zinc-600 flex flex-col items-center">
                <Search size={24} className="mb-2 opacity-50" />
                <span className="text-[10px] font-bold tracking-widest uppercase">NO MATCHING MEMBERS FOUND</span>
             </div>
          )}
        </div>
      </div>
          ...
          <div className="relative w-full max-w-md bg-zinc-950 border border-[#ccff00]/20 rounded-[32px] overflow-hidden p-8 animate-in zoom-in-95 shadow-[0_0_50px_rgba(204,255,0,0.1)]">
            ...
            <div className="space-y-6">
                 ...
                 <button 
                    ...
                    className="w-full bg-[#ccff00] text-black py-4 rounded-xl font-black text-xs tracking-[0.2em] uppercase hover:scale-[1.02] active:scale-95 transition-all shadow-[0_0_20px_rgba(204,255,0,0.2)] mt-4"
                >
                    CONFIRM EXTENSION & GENERATE KEY
                </button>
            </div>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-[120] flex items-center justify-center p-4">
          ...
          <div className="relative w-full max-w-md bg-zinc-950 border border-amber-500/20 rounded-[32px] overflow-hidden p-8 animate-in zoom-in-95 shadow-[0_0_50px_rgba(204,255,0,0.1)] flex flex-col items-center text-center">
            ...
            <p className="text-[10px] font-black text-zinc-500 tracking-[0.2em] uppercase leading-relaxed max-w-[280px] mb-8">
              YOU ARE INITIATING A CREDENTIAL RESET FOR <span className="text-white">{resetTarget.name}</span>. THIS REQUIRES USER CONFIRMATION.
            </p>
            ...
            <div className="w-full bg-amber-950/10 border border-amber-500/10 rounded-xl p-6 mb-8 text-left">
                <div className="font-mono text-[10px] font-bold text-amber-500/80 space-y-3">
                    <p className="flex items-center gap-3">
                        <span className="text-amber-500">&gt;</span> INITIATING HANDSHAKE...
                    </p>
                    <p className="flex items-center gap-3">
                        <span className="text-amber-500">&gt;</span> WAITING FOR ADMIN APPROVAL...
                    </p>
                    <p className="flex items-center gap-3 animate-pulse">
                        <span className="text-amber-500">&gt;</span> GENERATING NEW BHS KEY...
                    </p>
                </div>
            </div>
