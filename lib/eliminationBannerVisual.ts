...
export const DEFAULT_ELIMINATION_BANNER_FULL_LAYOUT: EliminationBannerFullOverlayLayout = {
  ...
  placement: { x: 88, y: 28, fontSize: 36, visible: true },
  teamName: { x: 88, y: 72, fontSize: 11, visible: true },
};
...
export const DEFAULT_ELIMINATION_BANNER_VISUAL: EliminationBannerVisual = {
  ...
  elimBannerLogoBg: '#ffffff',
  elimBannerMainBg: '#c41e1e',
  elimBannerMainBgEnd: '#7a0000',
  elimBannerPlacementBg: '#ffffff',
  ...
  elimBannerPlacementText: '#c41e1e',
  elimBannerNameText: '#ffffff',
  elimBannerSubtitleText: '#ff6b6b',
