import { isTeamMatchEliminated, teamHasAlivePlayer } from '@/lib/matchPlacements';
import type { RosterTeam } from '@/lib/teamRosterSync';
...
export type TeamRosterVisualPalette = typeof DEFAULT_PMGO_ROSTER_PALETTE;
