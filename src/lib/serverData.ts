...
import type { Ad, AppUpdateTask, Game, Member, MemberNotification, Theme } from '../types';
import {
...
const SEED_THEMES: Theme[] = [
  ...
  { id: 'mlbb-theme-01', gameId: 'mlbb', name: 'MPL OFFICIAL', desc: 'Mobile Legends Pro League Style', image: 'https://images.unsplash.com/photo-1511512578047-dfb367046420?q=80&w=2071&auto=format&fit=crop', tier: 'ULTIMATE', locked: false },
  { id: 'mlbb-theme-02', gameId: 'mlbb', name: 'MYTHIC ARENA', desc: 'Mobile Legends Mythic Theme 2', image: 'https://images.unsplash.com/photo-1542751371-adc38448a05e?q=80&w=2070&auto=format&fit=crop', tier: 'ULTIMATE', locked: false },
...
const LOCAL_KEYS: Record<ServerCollection, string> = {
  ...
  notifications: 'BROHUBS_SERVER_notifications',
};
...
const LOCAL_SEEDS: Partial<Record<ServerCollection, unknown[]>> = {
  ...
  themes: SEED_THEMES,
  ads: SEED_ADS,
  notifications: [] as MemberNotification[],
};
...
export const serverData = {
  ...
  /** Notifikasi admin → member */
  notifications: {
    getAll: (): Promise<MemberNotification[]> => listCollection<MemberNotification>('notifications'),
    saveAll: (notifications: MemberNotification[]): Promise<void> => replaceCollection('notifications', notifications),
  },
